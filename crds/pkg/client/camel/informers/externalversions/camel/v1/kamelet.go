...
import (
	...
	apiscamelv1 "github.com/apache/camel-kamelets/crds/pkg/apis/camel/v1"
	versioned "github.com/apache/camel-kamelets/crds/pkg/client/camel/clientset/versioned"
	internalinterfaces "github.com/apache/camel-kamelets/crds/pkg/client/camel/informers/externalversions/internalinterfaces"
	camelv1 "github.com/apache/camel-kamelets/crds/pkg/client/camel/listers/camel/v1"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options metav1.ListOptions) (runtime.Object, error) {
				...
				return client.CamelV1().Kamelets(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options metav1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.CamelV1().Kamelets(namespace).Watch(context.TODO(), options)
			},
		},
		&apiscamelv1.Kamelet{},
		resyncPeriod,
