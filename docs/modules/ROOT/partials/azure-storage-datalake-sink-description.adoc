...
In this Kamelet you have the possibility of using the `CLIENT_SECRET`, `SHARED_KEY_CREDENTIAL`, `AZURE_IDENTITY`, `AZURE_SAS` and `SERVICE_CLIENT_INSTANCE`. The default is `CLIENT_SECRET`.
